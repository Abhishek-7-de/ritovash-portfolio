  ...
  return (
    <section id="about" className="py-16 md:py-24">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-[28px] border-4 border-red-500 bg-red-500/5 p-6 md:p-8">
          <h3 className="text-xl font-semibold text-black font-['Press_Start_2P']">What he brings</h3>
        ...
        <div className="rounded-[28px] border-4 border-blue-500 bg-blue-500/5 p-6 md:p-8">
          <h3 className="text-xl font-semibold text-black font-['Press_Start_2P']">Core strength</h3>
          <p className="mt-4 text-sm leading-7 text-gray-800 sm:text-base">
